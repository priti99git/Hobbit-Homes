...
const Creatlisting = () => {
  ...
  const handlePost = async (e) => {
    e.preventDefault();
    try {
      // create new formData object to handle file uploads
      ...
      // append each sleected photos to the fromdata
      photos.forEach((photo) => {
        listingForm.append("listingPhotos", photo);
      });

      // send a post requiest to server
